...
<nav class="navbar-1-3 navbar navbar-expand-md navbar-dark p-4 px-md-3 mb-3 bg-purple">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          ...
          <div class="d-flex">
            <ul class="navbar-navmx-auto mb-2 mb-lg-0">
              <li class="nav-item">
                  <a class="nav-link px-md-3" href="#">Register</a>
              </li>
            </ul>
